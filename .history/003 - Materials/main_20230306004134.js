...
function addShapes() {
	...
	//
	const BoxGeometry = new THREE.BoxGeometry(1, 1, 50, 50, 50)
	const Box = new THREE.Mesh(BoxGeometry, lineBasic)
	scene.add(Box)

...
function addShapes() {
	...
	//
	const tourus = new THREE.TorusKnotGeometry(1, 0.3, 64, 8, 2, 3)
	...
	const Circle = new THREE.Mesh(CircleGeometry, toon)
	...
	const Dodecahedron = new THREE.Mesh(DodecahedronGeometry, toon)
	...
	// const TorusKnot = new THREE.Mesh(TorusKnotGeometry, toon)

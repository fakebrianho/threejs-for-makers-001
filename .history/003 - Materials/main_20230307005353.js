...
import { nav, resize } from './navigation'
...
function animate() {
	...
	scene.children[0].rotation.y += 0.012
	scene.children[0].rotation.z += 0.013
	scene.children[1].rotation.x += 0.013
	scene.children[1].rotation.y += 0.0032
	scene.children[1].rotation.z += 0.013
	scene.children[2].rotation.x -= 0.023
	scene.children[2].rotation.y += 0.012
	scene.children[2].rotation.z -= 0.013
	scene.children[3].rotation.x -= 0.0035
	scene.children[3].rotation.y += 0.002
	scene.children[3].rotation.z -= 0.003
	scene.children[4].rotation.x += 0.013
	scene.children[4].rotation.y -= 0.002
	scene.children[4].rotation.z += 0.003
	scene.children[5].rotation.x += 0.0113
	scene.children[5].rotation.y -= 0.022
	scene.children[5].rotation.z -= 0.013
